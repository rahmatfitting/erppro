...
export default function UangKeluarLainCreate() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (d.success) router.push(`/keuangan/uang-keluar-lain/${d.data?.id || d.id}`);
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 pb-12">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 flex-1"><ArrowUpCircle className="h-6 w-6 text-rose-600" /><h1 className="text-xl font-bold text-slate-900 dark:text-white">Uang Keluar Lain (UKL)</h1></div>
