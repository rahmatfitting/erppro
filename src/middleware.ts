...
export async function middleware(request: NextRequest) {
  ...
  const isAuthApi = path.startsWith("/api/auth") || path.includes("/api/migrate") || path.startsWith("/api/gold-prices/sync") || path.startsWith("/api/buyback-prices/sync") || path.startsWith("/api/debug") || path.startsWith("/api/crypto/hedge/scan") || path.startsWith("/api/crypto/bot/scan") || path.startsWith("/api/crypto/trader/scan") || path.startsWith("/api/crypto/visual-screener/scan") || path.startsWith("/api/crypto/funding-farming") || path.startsWith("/api/crypto/hedgefund-buy") || path.startsWith("/api/crypto/compound-bot") || path.startsWith("/api/crypto/narrative-onchain") || path.startsWith("/api/screener/scan");
